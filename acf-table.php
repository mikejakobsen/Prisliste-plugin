...
class acf_field_table extends acf_field {
    ...
    *  If ACF if above version 1.0.5
		*/
		...
		/*
		*  TableName (string) Single word, no spaces. Underscores allowed
		*/
		...
		*/
		...
		$this->l10n = array(
			'error'	=> __('Indtast venligst en større værdi', 'acf-table'),
		);
	...
	function render_field_settings( $field ) {
		...
		*/
		...
		acf_render_field_setting( $field, array(
			'label'			=> __('Tabel overskrift','acf-table'),
			'instructions'	=> __('Skal tabellen have en linje øverst til overskriften?','acf-table'),
			'type'			=> 'radio',
			'name'			=> 'use_header',
			'choices'   =>  array(
				0   =>  __( "Valgfri", 'acf-table' ),
				1   =>  __( "Ja", 'acf-table' ),
				2   =>  __( "Nej", 'acf-table' ),
			),
			'layout'	=>  'horizontal',
		...
		$e .= '<div class="acf-table-root">';
			...
			if ( $data_field['use_header'] === 0 ) {
				...
				$e .= '<div class="acf-table-optionbox">';
					$e .= '<label>' . __( 'Skal tabellen have en overskrift?', 'acf-table' ) . ' </label>';
					$e .= '<select class="acf-table-optionbox-field acf-table-fc-opt-use-header" name="acf-table-opt-use-header">';
						$e .= '<option value="0">' . __( 'Nej', 'acf-table' ) . '</option>';
						$e .= '<option value="1">' . __( 'Ja', 'acf-table' ) . '</option>';
					$e .= '</select>';
				$e .= '</div>';
			}
